...
describe("Game Logic Tests", () => {
  ...
  describe("getCellBorderStyle", () => {
    ...
    it("should return thick bottom border for cell in the last row", () => {
      ...
      expect(style.borderBottom).toBe(true);
    });
    ...
    it("should return thick right border for cell in the last column", () => {
      ...
      expect(style.borderRight).toBe(true);
    });
    ...
    it("should return thick borders between different areas", () => {
      ...
      expect(style.borderBottom).toBe(true); // Nedre grænse skal være tyk, da (2,1) er i område C

      style = getCellBorderStyle(2, 2);
      expect(style.borderRight).toBe(true); // Højre grænse skal være tyk, da (2,3) er i område B

      style = getCellBorderStyle(4, 1);
      expect(style.borderLeft).toBe(true); // Venstre grænse skal være tyk, da (4,0) er i område C

      style = getCellBorderStyle(3, 2);
      expect(style.borderTop).toBe(true); // Øverste grænse skal være tyk, da (2,2) er i område D
    });
  });
});
